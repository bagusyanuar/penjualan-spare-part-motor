    ...
    <div class="d-flex justify-content-between align-items-center mb-1">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Setting Kredit</li>
            </ol>
        </nav>
    </div>
    <div class="card-content">
        <div class="content-header mb-3">
            <p class="header-title">Data Setting Kredit</p>
            <a href="{{ route('admin.setting-kredit.add') }}" class="btn-add">
