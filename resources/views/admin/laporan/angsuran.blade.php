...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-1">
        <div>
            <p class="content-title">Laporan Angsuran</p>
            <p class="content-sub-title">Daftar data laporan angsuran</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">laporan angsuran</li>
            </ol>
        </nav>
    </div>
    <div class="card-content">
        <div class="content-header mb-3">
            <p class="header-title">Data Laporan angsuran</p>
        </div>
    ...
    <script>
        ...
        function generateTable() {
            table = $('#table-data').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'penjualan.user.customer.nama',
        ...
        $(document).ready(function () {
            ...
            $('#btn-print').on('click', function (e) {
                ...
                let start = $('#start').val();
                let end = $('#end').val();
                window.open('/admin/laporan-angsuran/cetak?start=' + start + '&end=' + end, '_blank');
            })
